...
_OPTIONAL_JSON_DEFAULTS: dict[str, Any] = {
    ...
    "lcmv_cold_start_rescue_enabled": False,
    "lcmv_cold_start_evaluation_interval_s": 0.1,
    "lcmv_cold_start_min_dominant_fraction": 0.90,
    "lcmv_cold_start_min_eigen_gap_db": 10.0,
    "lcmv_cold_start_max_interference_rank": 2,
    "lcmv_cold_start_secondary_eigen_gap_db": 6.0,
    "lcmv_cold_start_spectral_top_fraction": 0.01,
    "lcmv_cold_start_min_spectral_concentration": 0.60,
    "lcmv_cold_start_min_peak_over_median_db": 20.0,
    "lcmv_cold_start_wideband_rescue_enabled": False,
    "lcmv_cold_start_noise_reference_power_linear": 0.0,
    "lcmv_cold_start_wideband_min_excess_power_db": 20.0,
    "lcmv_cold_start_persistence_updates": 3,
    "lcmv_cold_start_release_updates": 30,
    "lcmv_cold_start_weight_update_interval_s": 1.0,
    "lcmv_cold_start_retarget_min_vector_coherence": 0.98,
    "lcmv_cold_start_retarget_persistence_updates": 10,
    "lcmv_cold_start_min_output_reduction_db": 3.0,
    "lcmv_cold_start_frequency_notch_enabled": False,
    "lcmv_cold_start_frequency_notch_bandwidth_hz": 100000.0,
    "lcmv_cold_start_frequency_notch_fir_taps": 257,
