                                ...
                                out_streams_(out_streams)
{
    ...
    pvt_output_parameters.log_rtklib_residuals = configuration->property(role + ".log_rtklib_residuals", pvt_output_parameters.log_rtklib_residuals);
    pvt_output_parameters.rtklib_residual_log_period_ms = configuration->property(role + ".rtklib_residual_log_period_ms", pvt_output_parameters.rtklib_residual_log_period_ms);
