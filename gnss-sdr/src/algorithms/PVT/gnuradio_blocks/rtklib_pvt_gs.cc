    ...
    if (d_enable_rx_clock_correction == true)
        {
            ...
            Pvt_Conf internal_conf = conf_;
            internal_conf.log_rtklib_residuals = false;
            d_internal_pvt_solver = std::make_shared<Rtklib_Solver>(internal_rtk, internal_conf, dump_ls_pvt_filename, d_signal_enabled_flags, false, false);
