...
gnss_sdr_sample_counter::gnss_sdr_sample_counter(
    ...
    : gr::sync_decimator("sample_counter",
          gr::io_signature::make(_ninputs, _ninputs, _size),
...
gnss_sdr_sample_counter_sptr gnss_sdr_make_sample_counter(double _fs, int32_t _interval_ms, size_t _size, size_t _ninputs)
{
    gnss_sdr_sample_counter_sptr sample_counter_(new gnss_sdr_sample_counter(_fs, _interval_ms, _size, _ninputs));
