...
def _install_product_fifo_bank(runtime: BackendRuntime) -> None:
    ...
    runtime._shared_u1_phase_bank = SharedU1PhaseCompensationBank(
        satellites=tuple(int(value) for value in cfg.gnss_shared_u1_phase_satellites),
...
def test_operator_disable_waits_for_inflight_lcmv_update_and_wins(
    ...
    real_solver = covariance_lcmv_ideal_null_weights
    ...
    monkeypatch.setattr(
        "antijamming.runtime.backend.covariance_lcmv_ideal_null_weights",
        blocked_solver,
    )
